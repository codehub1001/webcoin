...
export default function Landing() {
  // Animated counters (simple increment animation)
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Ethereum, BSC (Binance Smart Chain), Polygon, Solana (read-only metadata), Avalanche, Tron, Arbitrum and Base. More chains are added frequently."
    },
  ];
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-black via-slate-900 to-black text-white overflow-x-hidden">
      ...
      {/* HERO */}
      <section className="px-4 sm:px-8 lg:px-20 pt-8 pb-16 lg:pb-24 relative z-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

          <div>
            <motion.h1 initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="text-3xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-gray-300 mt-6 max-w-xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <a href="/scan" className="inline-flex items-center gap-3 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-lg font-semibold">
                Start Free Scan
              ...
              <a href="#how" className="inline-flex items-center gap-2 px-5 py-3 border border-white/10 rounded-lg text-sm text-gray-200 hover:bg-white/5">
                How it works
              </a>
            </div>

            {/* Stats quick row (small) */}
            <div className="mt-8 flex gap-6 flex-wrap">
              <div className="bg-white/3 rounded-xl px-4 py-3">
                <div className="text-xs text-gray-300">Wallets Secured</div>
                <div className="text-xl font-bold text-blue-400">{walletsSecured}+</div>
              </div>
              <div className="bg-white/3 rounded-xl px-4 py-3">
                <div className="text-xs text-gray-300">Threats Blocked</div>
                <div className="text-xl font-bold text-blue-400">{threatsBlocked}+</div>
              </div>
              <div className="bg-white/3 rounded-xl px-4 py-3">
                <div className="text-xs text-gray-300">Recoveries</div>
                <div className="text-xl font-bold text-blue-400">{recoveries}+</div>
              </div>
            </div>

          </div>

          {/* Right card: Live protection summary */}
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="bg-gradient-to-br from-white/3 to-white/5 border border-white/6 rounded-2xl p-6 backdrop-blur-md">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="mt-4 bg-white/5 p-3 rounded-lg border border-white/6">
                <div className="text-sm text-gray-300">Latest Alert</div>
      ...
      <section id="features" className="px-4 sm:px-8 lg:px-20 py-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {[
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.12 }} className="p-6 bg-gray-900 rounded-xl border border-gray-800">
      ...
      {/* Extended Trust / Features Grid (from earlier) */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            {["Metamask Wallet Secured","Trust Wallet Protection Enabled","Phantom Wallet Recovery","Cross-Chain Wallet Audit","AI-Powered Risk Scan","24/7 Security Monitoring"].map((item,i)=> (
              <motion.div key={i} initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{delay:i*0.1}} className="p-4 bg-gray-900 rounded-xl border border-gray-800 text-center">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            {[{name: 'Samuel O.', avatar: '', text: 'My wallet was compromised — CryptoGuard helped me detect the malicious approval and recover funds.'},
              ...
              <motion.div key={i} initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:i*0.12}} className="p-6 bg-gradient-to-br from-white/3 to-white/5 border border-white/6 rounded-2xl text-left">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-gray-900 rounded-xl border border-gray-800">
              ...
              <div className="text-4xl font-bold text-blue-400 mt-2">{walletsSecured}+</div>
            </div>
            <div className="p-6 bg-gray-900 rounded-xl border border-gray-800">
      ...
      {/* How it works — detailed with icons */}
      <section id="how" className="px-6 md:px-16 py-20 bg-gray-900 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className="p-6 bg-gray-800 rounded-xl border border-gray-700 text-left">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
            {[
              ...
              <motion.div key={i} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:i*0.08}} viewport={{once:true}} className="p-4 bg-gray-900 rounded-xl border border-gray-800 flex flex-col items-center gap-2">
      ...
      {/* Security Badge Row */}
      <section className="px-6 md:px-16 py-12 bg-gray-950 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <h3 className="text-2xl font-bold">Security standards</h3>
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            {['AES-256 Encryption', 'ISO 27001', 'SSL/TLS', 'Firewall Monitoring', 'Anti-Phishing Shield'].map((b,i)=> (
              <div key={i} className="px-4 py-2 bg-gray-900 rounded-lg border border-gray-800 text-gray-300">{b}</div>
            ))}
          </div>
        </div>
      </section>
      ...
      {/* Scrolling Marquee */}
      <section className="overflow-hidden py-4 bg-black border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 text-gray-400 text-sm">
            <div className="marquee">
              {marquee.concat(marquee).map((m,i)=> (
                <span key={i} className="mr-10">{m}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* FAQ */}
      <section id="faq" className="px-6 md:px-16 py-16 bg-gray-900 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold">Frequently asked questions</h2>
          <div className="mt-8 space-y-4 text-left">
            {faqs.map((f,i)=> (
              <details key={i} className="p-4 bg-gray-800 rounded-lg border border-gray-700">
      ...
      {/* CTA with glow */}
      <section className="px-6 md:px-16 py-16 bg-gradient-to-r from-blue-900 to-indigo-900 border-t border-gray-800 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">Ready to secure your wallet?</h2>
          <p className="text-gray-200 mt-3">Start a free scan and get an instant security report with step-by-step remediation.</p>
          <div className="mt-8">
            <a href="/scan" className="inline-block px-8 py-4 bg-white/6 hover:bg-white/10 text-white rounded-xl font-semibold shadow-2xl ring-1 ring-white/10">Start Free Scan</a>
          </div>
        </div>
      </section>

      {/* Footer */}
      <footer className="px-6 md:px-16 py-8 bg-black/80 border-t border-gray-900">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center font-bold">CG</div>
            <div>
              <div className="font-semibold">CryptoGuard</div>
              <div className="text-xs text-gray-400">Wallet protection platform</div>
            </div>
          </div>

          <div className="text-sm text-gray-400">© {new Date().getFullYear()} CryptoGuard • All rights reserved</div>
